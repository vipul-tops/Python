...
class Bill_App:
    ...
    def total(self):
        ...
        self.m_m_p = self.mask.get()*15
        self.m_s_p = self.syrup.get()*70
        self.m_c_p = self.cream.get()*40
        self.m_t_g_p = self.thermal_gun.get()*20
        ...
        self.c_tax = round((self.total_medical_price*0.1), 2)
        ...
        self.g_s_p = self.spices.get()*30
        self.g_f_p = self.flour.get()*20
        self.g_m_p = self.maggi.get()*30
        self.total_grocery_price = float(self.g_r_p+self.g_f_o_p+self.g_w_p+self.g_s_p+self.g_f_p+self.g_m_p)

        self.grocery_price.set("Rs. " + str(self.total_grocery_price))
        self.g_tax = round((self.total_grocery_price*0.2), 2)
        ...
        self.c_d_l_p = self.lassi.get()*20
        ...
        self.c_d_tax = round((self.total_cold_drinks_price * 0.3), 2)
